...
if uploaded_file is not None:
    ...
    if generate:
        ...
        with st.spinner("Generating..."):
            ...
            Could you always explain your methodology and how you concluded? Provide steps to verify your work. Also, mention the percentage of how sure you are of the place you have identified it to be and add a Google Maps link having google.com/maps to the exact location.""")
